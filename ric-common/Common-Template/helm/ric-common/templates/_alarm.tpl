...
{{- define "common.serviceport.alarmadp.rmr.data" -}}4560{{- end -}}
{{- define "common.serviceport.alarmadp.rmr.route" -}}4561{{- end -}}
{{- define "common.serviceport.alarmadp.http" -}}8080{{- end -}}
