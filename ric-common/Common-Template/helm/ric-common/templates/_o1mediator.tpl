...
{{- define "common.servicename.o1mediator.rmr" -}}
  {{- $name := ( include "common.fullname.o1mediator" . ) -}}
  {{- printf "service-%s-rmr" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "common.servicename.o1mediator.http.supervise" -}}
  {{- $name := ( include "common.fullname.o1mediator" . ) -}}
  {{- printf "service-%s-http-supervise" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "common.servicename.o1mediator.http.mediation" -}}
  {{- $name := ( include "common.fullname.o1mediator" . ) -}}
  {{- printf "service-%s-http-mediation" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "common.servicename.o1mediator.http.event" -}}
  {{- $name := ( include "common.fullname.o1mediator" . ) -}}
  {{- printf "service-%s-http-event" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- define "common.serviceport.o1mediator.rmr.data" -}}4562{{- end -}}
{{- define "common.serviceport.o1mediator.rmr.route" -}}4561{{- end -}}
