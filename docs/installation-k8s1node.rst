...
will replace any existing installation of Docker host, Kubernetes, and Helm on the VM.  For 
example:
...
Upon successful execution of the script, when queried with the kubectl command as shown below,
the VM should display information similar to below:
